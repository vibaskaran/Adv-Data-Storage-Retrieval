...
Use SQLAlchemy to model your table schemas and create a sql database for your tables. You will need one table per weather station. Use the station name as the table name.

* Create a Jupyter Notebook called `database_engineering.ipynb` and use this to complete all of your Database Engineering work.

* Use Pandas to read your cleaned measurements and stations CSV data.

* Use the `engine` and connection string to create a database called `hawaii.sqllite` or a cloud based sql database..
...
* Use SQLAlchemy `create_engine` to connect to your sqlite (or cloud) database.
